...
signals:
  ...
  void loadStart(int browserId, const QCefFrameId& frameId, bool isMainFrame, int transitionType);
  ...
  void loadEnd(int browserId, const QCefFrameId& frameId, bool isMainFrame, int httpStatusCode);
  ...
  void cefQueryRequest(int browserId, const QCefFrameId& frameId, const QCefQuery& query);
  ...
  void invokeMethod(int browserId, const QCefFrameId& frameId, const QString& method, const QVariantList& arguments);
