...
void
MainWindow::onQCefQueryRequest(int browserId, const QCefFrameId& frameId, const QCefQuery& query)
{
...
void
MainWindow::onLoadStart(int browserId, const QCefFrameId& frameId, bool isMainFrame, int transitionType)
{
...
void
MainWindow::onLoadEnd(int browserId, const QCefFrameId& frameId, bool isMainFrame, int httpStatusCode)
{
